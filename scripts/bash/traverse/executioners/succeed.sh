...
# Usage          : ./succeed.sh /path/to/subdirectory
...
# Description	 : Script to succeed on each sub-directory. This script is just for testing purposes.
...
echo "Success for directory $dir" >&2
exit 0
